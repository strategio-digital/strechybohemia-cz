<template>
  <div v-if="payment.state === 'paid'">
    ...
    <p><span class="fw-bold text-success">Objednávka byla úspěšně uhrazena</span>, teď prosím vyčkejte, servisní technik
      se s Vámi spojí.</p>
    <p class="text-danger">Veškeré podrobnosti jsme <span class="fw-bold">odeslali na Váš e-mail</span> (prosím,
      zkontrolujte si i složku SPAM).</p>
  </div>
  ...
  <div v-else-if="payment.state === 'waiting'">
    ...
    <p>Veškeré podrobnosti jsme <span class="fw-bold">odeslali na Váš e-mail</span> (prosím, zkontrolujte si i složku
      SPAM).</p>
