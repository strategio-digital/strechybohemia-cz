<template>
  ...
  <form @submit.prevent="submitHandler('next')" class="mt-3">
    <div class="form-floating mb-3">
      <input @input="changeName" :value="billing.name" :class="!nameValid ? 'is-invalid' : ''" placeholder="Jméno a příjmení" type="text" class="form-control" id="name">
    ...
    <div class="form-floating mb-3">
      <input @input="changeStreet" :value="billing.street" :class="!streetValid ? 'is-invalid' : ''" placeholder="Ulice a číslo popisné" type="text" class="form-control" id="street">
    ...
    <div class="form-floating mb-3">
      <input @input="changeCity" :value="billing.city" :class="!cityValid ? 'is-invalid' : ''" placeholder="Obec / město" type="text" class="form-control" id="city">
    ...
    <div class="form-floating mb-3">
      <input @input="changeZip" :value="billing.zip" :class="!zipValid ? 'is-invalid' : ''" placeholder="PSČ" type="text" class="form-control" id="zip">
    ...
    <div class="form-floating mb-3">
      <input @input="changeCompanyId" :value="billing.companyId" :class="!companyIdValid ? 'is-invalid' : ''" placeholder="IČO" type="text" class="form-control" id="company_id">
...
import { isCompanyId, isVatId, isZipCode } from "../../../typescript/Helpers/Validation";
